...
public class MNode implements Serializable {
  ...
  private double originSampleEntropy;
  private double peakSampleEntropy;
  private double currSampleEntropy;
  ...
  public MNode(String name, MNode parent, TSDataType dataType, TSEncoding encoding,
    ...
    this.originSampleEntropy = Double.NaN;
    this.peakSampleEntropy = Double.NaN;
    this.currSampleEntropy = Double.NaN;
  }
  ...
  public double getOriginSampleEntropy() {
    return originSampleEntropy;
  }

  public void setOriginSampleEntropy(double originSampleEntropy) {
    this.originSampleEntropy = originSampleEntropy;
  }

  public double getPeakSampleEntropy() {
    return peakSampleEntropy;
  }

  public void setPeakSampleEntropy(double peakSampleEntropy) {
    this.peakSampleEntropy = peakSampleEntropy;
  }

  public double getCurrSampleEntropy() {
    return currSampleEntropy;
  }

  public void setCurrSampleEntropy(double currSampleEntropy) {
    this.currSampleEntropy = currSampleEntropy;
  }
