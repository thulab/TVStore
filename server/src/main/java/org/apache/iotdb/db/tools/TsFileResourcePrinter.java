...
public class TsFileResourcePrinter {
  ...
  static long totalActualPageNum = 0;
  static long totalVirtualPageNum = 0;
  public static void main(String[] args) throws IOException {
    ...
    System.out.println("TotalActualPageNum="+totalActualPageNum+", virtualPageNum="+totalVirtualPageNum);
  ...
  public static void printResource(String filename) throws IOException {
    ...
    totalActualPageNum+=resource.getActualPageNum();
    totalVirtualPageNum+=resource.getVirtualPageNum();
    System.out.println(filename+": ActualPageNum="+resource.getActualPageNum()+", virtualPageNum="+resource.getVirtualPageNum());
  }
}
