...
public abstract class AggregateFunction {
   ...
   *
   * @param pageHeader <code>PageHeader</code>
   * @param ratio <code>PageHeader</code>
   */
  public abstract void calculateValueFromPageHeader(PageHeader pageHeader, double ratio)
      throws QueryProcessException;
   ...
   */
  public abstract void calculateValueFromPageData(PageHeader pageHeader, BatchData dataInThisPage,
