...
public class TsFileResource {
  ...
  public void serialize() throws IOException {
    try (OutputStream outputStream = fsFactory.getBufferedOutputStream(
      ...
      ReadWriteIOUtils.write(actualPageNum, outputStream);
      ReadWriteIOUtils.write(virtualPageNum, outputStream);
      logger.info("write tsfile resourse {}, actPage = {}, virPage = {}",file.getName(), actualPageNum, virtualPageNum);
    }
  ...
  public void deSerialize() throws IOException {
    try (InputStream inputStream = fsFactory.getBufferedInputStream(
      ...
      actualPageNum = ReadWriteIOUtils.readInt(inputStream);
      virtualPageNum = ReadWriteIOUtils.readInt(inputStream);
      logger.info("read tsfile resourse {}, actPage = {}, virPage = {}",file.getName(), actualPageNum, virtualPageNum);
    }
  }
