...
public class IoTDBLargeDataIT {
  ...
  //@Test
  public void selectCompressRatioTest() throws ClassNotFoundException, SQLException {
    String selectSql = "select * from root.vehicle compress ratio";
  ...
  public void seriesGlobalTimeFilterTest() throws ClassNotFoundException, SQLException {
    ...
    try (Connection connection = DriverManager
      ...
      hasResultSet = statement
          .execute("select s0 from root.vehicle.d0 where time > -9 and time < -3");
