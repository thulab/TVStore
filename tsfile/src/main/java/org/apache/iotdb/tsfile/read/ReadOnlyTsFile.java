...
public class ReadOnlyTsFile implements AutoCloseable {
  ...
  public static void main(String[] args) throws IOException {
    String filename = "/Users/suyue/input/tsfileCom/1605200267483-101-0.tsfile";
    String outFile = "/Users/suyue/input/tsfileCom/1605200267483-101-0.tsfile.output";
    ReadOnlyTsFile readOnlyTsFile = new ReadOnlyTsFile(new TsFileSequenceReader(filename));
    QueryExpression queryExpression =  QueryExpression.create();
    queryExpression.addSelectedPath(new Path("root.group_3.d.s3"));
