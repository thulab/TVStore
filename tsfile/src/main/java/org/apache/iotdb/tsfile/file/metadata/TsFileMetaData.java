...
public class TsFileMetaData {
  ...
  public static TsFileMetaData deserializeFrom(InputStream inputStream, boolean isOldVersion)
    ...
    fileMetaData.actualPageNum = ReadWriteIOUtils.readInt(inputStream);
    fileMetaData.virtualPageNum = ReadWriteIOUtils.readInt(inputStream);
  ...
  public static TsFileMetaData deserializeFrom(ByteBuffer buffer, boolean isOldVersion)
    ...
    fileMetaData.actualPageNum = ReadWriteIOUtils.readInt(buffer);
    fileMetaData.virtualPageNum = ReadWriteIOUtils.readInt(buffer);
    // read bloom filter
  ...
  public int serializeTo(OutputStream outputStream) throws IOException {
    ...
    byteLen += ReadWriteIOUtils.write(actualPageNum, outputStream);
    byteLen += ReadWriteIOUtils.write(virtualPageNum, outputStream);
  ...
  public int serializeTo(ByteBuffer buffer) throws IOException {
    ...
    byteLen += ReadWriteIOUtils.write(actualPageNum, buffer);
    byteLen += ReadWriteIOUtils.write(virtualPageNum, buffer);
    return byteLen;
  }
